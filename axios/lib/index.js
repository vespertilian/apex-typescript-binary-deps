...
function default_1(e, ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var urls, res, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    urls = ['https://cameronbatt.com'];
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, Promise.all(urls.map(function (url) {
                            return __awaiter(this, void 0, void 0, function () {
                                var _a;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 1: return [2 /*return*/, (_a.status = (_b.sent()).status,
                                                _a.url = url,
                                                _a)];
                                    }
                                });
